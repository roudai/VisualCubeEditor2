const app = Vue.createApp({
  ...
  watch: {
    ...
    faceletsU6: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsR6: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsF6: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsD6: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsL6: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsB6: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsU5: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsR5: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsF5: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsD5: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsL5: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsB5: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsU4: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsR4: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsF4: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsD4: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsL4: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsB4: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsU3: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsR3: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsF3: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsD3: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsL3: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsB3: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsU2: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsR2: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsF2: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsD2: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsL2: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsB2: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsU1: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsR1: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsF1: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsD1: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsL1: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
    faceletsB1: { handler: function() { if(this.drawFlag) {this.drawCube(); this.drawFlag = false }}, deep: true },
